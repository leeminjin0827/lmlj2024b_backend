...
# create (생성한다뜻) database(데이터베이스) DB명
# create database DB명
create database mydb1226;

# [4] db server 의 데이터베이스 삭제하기.
# drop(버린다는뜻) database(데이터베이스) DB명 , drop dataabase DB명
