...
public class Example1 {
	public static void main(String[] args) {
		...
		for( int index = 0; index <= names.length -1; index++ ) {
			System.out.println( names[index] ); // 유재석 강호동 신동엽
		} // for end
		// [4] 배열내 길이 이상의 요소 대입 , 길이가 3이면 인덱스 0 ~ 2 가 존재한다.
		// names[3] = "하하";	 // 오류 Index 3 out of bounds for length 3
		// [5] 배열내 중간 요소 삭제
		names[1] = null;	 // 고정길이 , 삭제 개념이 존재하지 않는다. 요소값을 null 비워서 사용이 가능하지만 요소 자체 삭제 불가능
		
// ===================================================== 비교 =====================================================
		
		// [1] ArrayList 클래스 , 배열과 다르게 가변길이로 사용이 가능하다. 단점 : 라이브러리 는 느리다.
			// import java.util.ArrayList;
			// < 제네릭 타입 > : 리스트 에 저장할 객체의 타입
		...
		nameList.remove( 1 ); // index가 1인 '강호동' 요소 삭제 // 배열과 다르게 리스트는 가변길이 이므로 요소 삭제가 가능
