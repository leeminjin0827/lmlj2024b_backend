package day17.step1; // 01 02 / 10 30
...
class Tool1  implements InterfaceTest {
	...
	// [2] 추상메소드 구현하기
		// 1. 선언부 동일하게 작성해야 한다. 접근제한자 변한타입명 메소드명 ( 타입 매개변수 )
		// 2. 오버라이딩 : 상속 또는 구현 했을때 메소드 재정의
	public int method2( int a ) {
		System.out.println("[tool1 클래스 구현한 method]");
		return a;
	} // f end
	@Override
	public int method3(int a) {
		System.out.println("[tool 1 클래스가 구현한 method3]");
		return a;
	} // f end
} // c end
...
class Tool2 implements InterfaceTest {
	...
	@Override
	public int method3(int a) {
		System.out.println("[tool2 클래스가구현한 method3]");
		return a;
	}
