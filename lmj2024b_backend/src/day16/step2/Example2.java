...
public class Example2 {
	public static void main(String[] args) {
		...
		System.out.println( obj1.value1 ); // 10	// 본인 인스턴스에 멤버변수 호출 // 단 하위 클래스의 멤버변수 접근 불가능
		// 2. 하위클래스 인스턴스 생성
		하위클래스 obj2 = new 하위클래스();
		System.out.println( obj2.value1 ); // 100	// 만일 상위클래스와 하위클래스의 멤버변수명이 동일하면 현재 인스턴스의 멤버변수가 우선순위
