...
public class Example1 {
	public static void main(String[] args) {
		...
		// [1] 일반 예외 : 컴파일러 예외처리 검사 , 자동으로 예외처리 하라고 경고가뜸.
		...
		}catch( ClassNotFoundException e ) { // try 에서 예외가 발생하거나 할것 같은 예외클래스명 변수명
				System.out.println( e );	// 만일 try 에서 지정한 예외클래스가 발생하면 실행코드
		}
		// [2] 일반 예외
			// System.in.read() : 시스템 으로부터 읽기 함수 , IOException
		try {
			System.in.read();
		}catch( IOException e ) {
