...
/*
 	실습1 : 게시판 프로그램
 		...
 		-  게시물 3개 저장 하기. 게시물1개당 제목/내용/작성자 저장소3개 필요 , 게시물3 --> 9개필요.
	...
	public static void main(String[] args) {
		...
		while(true) { // [1] 반복문 , 무한루프
			...
			if( 선택메뉴 == 1 ) { System.out.println(">> 1.등록 선택했습니다.");
				...
				// [7] 변수값에 따른 데이터 검사 후 대입 // 첫번째 게시물이 비어 있으면 // [6-2] 변수값 수정
				...
				// 오류가 발생하는 이유 : 변수의 초기값(처음에 변수 만들때 값을 넣는 행위-초기화) 없다. // - 지억변수가 초기값이 없으면 호출이 불가능하다.
			} // i end
		} // w end
	} // m end
} // c end
